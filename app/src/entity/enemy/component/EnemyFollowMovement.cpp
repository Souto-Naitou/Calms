#include "EnemyFollowMovement.h"



EnemyFollowMovement::EnemyFollowMovement(const Vector3* pTargetPosition)
{
    pTargetPosition_ = pTargetPosition;
}

void EnemyFollowMovement::Update(EulerTransform& transform, float deltaTime)
{
